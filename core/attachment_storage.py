...
class AttachmentStorage:
    ...
    def save_attachment_from_path(
        ...
        try:
            ...
            # copy2 preserves the source timestamp when shutil.move crosses
            # filesystems. Refresh the published file after the copy completes
            # so a long transfer cannot be swept as expired immediately.
