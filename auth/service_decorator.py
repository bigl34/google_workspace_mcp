...
from auth.scopes import (
    ...
    ADMIN_DIRECTORY_USER_ALIAS_READONLY_SCOPE,
    ADMIN_DIRECTORY_USER_ALIAS_SCOPE,
...
SERVICE_CONFIGS = {
    ...
    "groupssettings": {"service": "groupssettings", "version": "v1"},
...
SCOPE_GROUPS = {
    ...
    "gmail_settings_sharing": GMAIL_SETTINGS_SHARING_SCOPE,
    "admin_user_read": ADMIN_DIRECTORY_USER_READONLY_SCOPE,
    "admin_alias_read": ADMIN_DIRECTORY_USER_ALIAS_READONLY_SCOPE,
    "admin_alias_write": ADMIN_DIRECTORY_USER_ALIAS_SCOPE,
    "admin_group_read": ADMIN_DIRECTORY_GROUP_READONLY_SCOPE,
    "admin_group_write": ADMIN_DIRECTORY_GROUP_SCOPE,
    "groups_settings": GROUPS_SETTINGS_SCOPE,
    # Drive scopes
    "drive": DRIVE_SCOPE,
