    ...
    "admin": [
        (
            ...
            [
                ...
                ADMIN_DIRECTORY_USER_ALIAS_READONLY_SCOPE,
                ADMIN_DIRECTORY_GROUP_READONLY_SCOPE,
                # Google exposes no read-only Groups Settings scope. The MCP
                # admin surface only registers a read tool for this scope.
                GROUPS_SETTINGS_SCOPE,
            ],
        ),
        ("full", [ADMIN_DIRECTORY_USER_ALIAS_SCOPE, ADMIN_DIRECTORY_GROUP_SCOPE]),
    ],
    "drive": [
