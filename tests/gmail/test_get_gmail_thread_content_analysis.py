        ...
        "messages": [
            {
                ...
                "payload": {
                    "headers": [
                        {"name": "From", "value": "Example User <user@example.com>"},
                        {"name": "Reply-To", "value": "user-support@example.com"},
...
async def test_default_returns_string_unchanged_behavior():
    ...
    assert "user@example.com" in result or "Example User" in result
    assert "Reply-To: user-support@example.com" in result
